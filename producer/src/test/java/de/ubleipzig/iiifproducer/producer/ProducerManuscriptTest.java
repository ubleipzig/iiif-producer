...
public class ProducerManuscriptTest {
    ...
    @Test
    public void testMSType1() {
        String testFileSource2 = Objects.requireNonNull(
                ProducerMonographTest.class.getResource("/MS_187.xml")).getPath();
        final String[] args = new String[]{"-v", "0000004595", "-x", testFileSource2, "-o",
