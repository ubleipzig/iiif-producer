...
public class ProducerMonographV2Test {

    private static final String configFilePath = Objects.requireNonNull(ProducerMonographV2Test.class.getResource(
    ...
    public void testStandardTypeV2() {
        String testFileSource1 = Objects.requireNonNull(
                ProducerMonographV2Test.class.getResource("/BlhDie_004285964.xml")).getPath();
