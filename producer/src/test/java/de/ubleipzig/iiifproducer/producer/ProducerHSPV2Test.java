...
public class ProducerHSPV2Test {

    private static final String configFilePath = Objects.requireNonNull(ProducerHSPV2Test.class.getResource(
            "/producer-config-test.yml")).getPath();
    private static final String pid = "producer-test-" + UUID.randomUUID();

    @Test
    public void testHSPV2Type() {
        String testFileSource1 = Objects.requireNonNull(
                ProducerHSPV2Test.class.getResource("/DieHadeT_1525437259.xml")).getPath();
