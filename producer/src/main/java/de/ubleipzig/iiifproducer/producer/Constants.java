...
final class Constants {
    ...
    static final String KATALOG_URL = "https://katalog.ub.uni-leipzig.de/urn/";
    ...
    static final String LICENSE = "https://creativecommons.org/publicdomain/mark/1.0/";
    static final String ATTRIBUTION_LICENSE_NOTE = "No Copyright - Public Domain Marked";
    ...
    static final String IMAGE_MANIFEST_OUTPUT_DIR = "/tmp";
